...
export const t = {
  es: {
    ...
    gratPage: {
      ...
      ctaGift: 'Quiero mis 7 tarjetas gratis',
      ...
      bridge: {
        ...
        steps: [
          ...
          { n: '2', t: 'Respira con la mano en el corazón', d: 'Tres respiraciones lentas. Estás aquí. Sigues de pie. Eso ya es mucho.' },
          { n: '3', t: 'Busca una cosa que sigue en pie', d: 'Un techo. Una llamada. Una taza caliente. Hoy, una sola basta.' },
      ...
      decks: {
        ...
        etsy: 'Ver Calma en Etsy',
      },
      faith: {
        verse: '«Den gracias en toda circunstancia, porque esta es la voluntad de Dios para ustedes.»',
        ref: '1 Tesalonicenses 5:18',
        close: 'La gratitud no cambia lo que estás viviendo. Cambia el corazón con el que lo vives. Y tú nunca caminas sola.',
  ...
  en: {
    ...
    gratPage: {
      ...
      ctaGift: 'Send me my 7 free cards',
      ...
      bridge: {
        ...
        steps: [
          ...
          { n: '2', t: 'Breathe with your hand on your heart', d: 'Three slow breaths. You are here. You are still standing. That is already a lot.' },
          { n: '3', t: 'Find one thing still standing', d: 'A roof. A phone call. A warm cup. Today, just one is enough.' },
          { n: '4', t: 'Thank God for that one thing', d: 'You do not need a perfect prayer. A whispered thank you also reaches heaven.' },
        ],
      ...
      decks: {
        ...
        etsy: 'View Calm on Etsy',
      },
      faith: {
        verse: '"Give thanks in all circumstances, for this is the will of God for you."',
        ref: '1 Thessalonians 5:18',
        close: 'Gratitude does not change what you are living through. It changes the heart you live it with. And you never walk alone.',
        back: 'Back to home',
      },
    },
    hero: {
